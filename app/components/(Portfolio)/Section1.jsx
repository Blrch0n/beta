      ...
      <div className="max-w-[1140px] max-[1200px]:px-20 max-[768px]:grid-cols-1 w-full h-fit grid grid-cols-2 grid-rows-3 gap-10">
        {section1_data.map((data, index) => (
          <div className="w-full h-full relative group" key={index}>
            ...
            <a
              className="w-[80%] h-fit opacity-0 group-hover:opacity-80 duration-300 px-[14px] py-[20px] flex flex-col gap-3 bg-white bottom-[10%] right-[10%] absolute"
            ...
            >
              ...
              <div className="w-full h-fit flex items-center justify-between">
                <p className="text-[20px] text-[#333] font-semibold font-mulish">
                  Portfolio, Look, Life, Good
                </p>
                <MdOutlineLaunch className="text-[#6134CF] text-[20px]" />
              </div>
            </a>
          </div>
        ))}
